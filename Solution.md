...
```text
aws ec2 run-instances --image-id ami-0aa210fd2121a98b7 --instance-type m7i-flex.large --key-name halit-key --security-group-ids sg-0268343164cc21c11 --subnet-id subnet-0813ebffddba31dd3 --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=ondia-capstone-nat-instance-dont-terminate}]' --disable-api-termination
```10

- for example
```text
aws ec2 run-instances --image-id ami-0aa210fd2121a98b7 --instance-type m7i-flex.large --key-name ondia-paulosx --security-group-ids sg-03f6e54974bde1a20 --subnet-id subnet-0658102571b408128 --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=ondia-capstone-nat-instance-dont-terminate}]' --disable-api-termination
```

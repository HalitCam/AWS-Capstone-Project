...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/halit/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/halit/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'database-instance.ccdk0q246eof.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'halit-capstone-blog' # please enter your s3 bucket name
